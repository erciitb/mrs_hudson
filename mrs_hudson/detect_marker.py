...
class ArUcoDetector(Node):
    ...
    def detect_ArUco(self, img):
        ...
        parameters = cv2.aruco.DetectorParameters()  # Correct method for creating parameters

        detector = cv2.aruco.ArucoDetector(aruco_dict, parameters)  # Create ArucoDetector object
        corners, ids, _ = detector.detectMarkers(gray)  # Use the detectMarkers method of ArucoDetector
